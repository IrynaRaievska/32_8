fn:=function(x)
local log;
log := Concatenation("End32_8mult_",String(x),".txt");
return log;end;
fn1:=function(x)
local fu;
fu := Concatenation("End32_8mult_",String(x));
return fu;end;
fn2:=function(x,y)
local fun;
fun := Concatenation("End32_8mult_",String(x),"_",String(y));
return fun;end;
fn3:=function(x,y)
local func;
...
fn4:=function(i3,i4)
local name;
name := Concatenation("Endom32_8-",String(i3),"_",String(i4),".txt");
return name;end;
